...
MERCHANT_SECRET_KEY = "flk3409refn54t54t*FNJRET" # Стандартний тестовий ключ WayForPay
...
def payment_webhook():
    ...
    коли гроші успішно списалися. Навіть якщо користувач закрив браузер, 
    цей код спрацює і зафіксує оплату в базі даних.
    """
    data = request.json
